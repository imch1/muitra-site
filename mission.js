...
const I18N = {
  en: {
    ...
    "mission.ctaBody": "Muitra is live on iPhone and Android. Open the download section and pick your store.",
  ...
  fr: {
    ...
    "mission.ctaBody": "Muitra est disponible sur iPhone et Android. Ouvrez la section de telechargement pour choisir votre store.",
  ...
  es: {
    ...
    "mission.ctaBody": "Muitra ya esta disponible en iPhone y Android. Abre la seccion de descarga y elige tu store.",
